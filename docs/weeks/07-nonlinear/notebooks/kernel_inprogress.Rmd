...
#### Experiment with changing `f`, `n`, `s2`, and `noise_sd`
...
Use the `ksvm` function to fit non-linear kernel regression models and plot the predictions on `train1d_grid`
