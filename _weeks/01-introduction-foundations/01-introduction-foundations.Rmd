...
- Part 1 slides: [[html](slides/01-1-introduction.html)] [[pdf](slides/01-1-introduction_simple.pdf)]
- Part 2 slides: [[html](slides/01-2-foundations.html)] [[pdf](slides/01-2-foundations_simple.pdf)]
- [Notebook](notebooks/gapminder.html) for `gapminder` example
- [Notebook](notebooks/candy.html) for `candy` example
- [Notebook](notebooks/seminar.html) from previous (outdated) seminar
