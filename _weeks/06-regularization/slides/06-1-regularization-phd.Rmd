...
```{r jsn5p4, cache = FALSE}
JS_MC(n = 5, p = 4)
JS_MC(n = 5, p = 4)
```

```{r jsn50p4, cache = FALSE}
...
```{r jsn5p100, cache = FALSE}
JS_MC(n = 2, p = 1000)
JS_MC(n = 2, p = 1000)
```

```{r jsn50p100, cache = FALSE}
...
```{r ridgen100p10, cache = FALSE}
high_dim_MSE_MC(n = 100, p = 10)
```

```{r ridgen100p90, cache = FALSE}
high_dim_MSE_MC(n = 100, p = 90)
high_dim_MSE_MC(n = 100, p = 90)
```

```{r ridgen1000p990, cache = FALSE}
